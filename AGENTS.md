...
- **`figure_esm.js`** — pure-JS canvas renderer (~12,080 lines); all rendering logic lives here. **Read `anyplotlib/FIGURE_ESM.md` first** — it is the section map.
...
the 2-D function table). Both were last verified at 12,077 lines.
...
| `anyplotlib/figure_esm.js` | All JS canvas rendering (~12,080 lines) |
